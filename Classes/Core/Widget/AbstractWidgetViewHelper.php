...
abstract class Tx_Fluid_Core_Widget_AbstractWidgetViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper implements Tx_Fluid_Core_ViewHelper_Facets_ChildNodeAccessInterface {
	...
	public function injectObjectManager(Tx_Extbase_Object_ObjectManagerInterface $objectManager) {
		...
		$this->widgetContext = $this->objectManager->get('Tx_Fluid_Core_Widget_WidgetContext');
	}
	...
	public function setChildNodes(array $childNodes) {
		$rootNode = $this->objectManager->get('Tx_Fluid_Core_Parser_SyntaxTree_RootNode');
	...
	protected function initiateSubRequest() {
		...
		$subRequest = $this->objectManager->get('Tx_Fluid_Core_Widget_WidgetRequest');
		$subRequest->setWidgetContext($this->widgetContext);
		$this->passArgumentsToSubRequest($subRequest);
		$subResponse = $this->objectManager->get('Tx_Extbase_MVC_Web_Response');
