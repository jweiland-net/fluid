...
class Tx_Fluid_ViewHelpers_FormViewHelper extends Tx_Fluid_ViewHelpers_Form_AbstractFormViewHelper {
	...
	/**
	 * @param Tx_Extbase_MVC_Controller_MvcPropertyMappingConfigurationService $mvcPropertyMapperConfigurationService
	 * @return void
	 */
	public function injectMvcPropertyMapperConfigurationService(Tx_Extbase_MVC_Controller_MvcPropertyMappingConfigurationService $mvcPropertyMapperConfigurationService) {
