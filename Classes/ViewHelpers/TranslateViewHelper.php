...
class Tx_Fluid_ViewHelpers_TranslateViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	public function render() {
		...
		if (strlen($id) > 0) {
			...
			throw new Tx_Fluid_Core_ViewHelper_Exception_InvalidVariableException('An argument "key" or "id" has to be provided', 1351584844);
		}
	}
	...
	protected function renderTranslation($id) {
		...
		$value = Tx_Extbase_Utility_Localization::translate($id, $extensionName, $this->arguments['arguments']);
		if ($value === NULL) {
