...
class Tx_Fluid_ViewHelpers_Form_TextfieldViewHelper extends Tx_Fluid_ViewHelpers_Form_AbstractFormFieldViewHelper {
	...
	public function initializeArguments() {
		...
		$this->registerArgument('formatDateTime', 'string', 'If value is of datatype DateTime you can set a display format here', FALSE, $GLOBALS['TYPO3_CONF_VARS']['SYS']['ddmmyy']);
	...
	public function render($required = NULL, $type = 'text', $placeholder = NULL) {
		...
		if ($value !== NULL) {
			if ($value instanceof \DateTime) {
				$value = $value->format($this->arguments['formatDateTime']);
			}
